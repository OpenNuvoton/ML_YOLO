...
set MODEL_SRC_DIR=..\darknet_tflite\myModel\coco_person\output_model
set MODEL_SRC_FILE=yolo-fastest-1.1-person-int8.tflite
set MODEL_OPTIMISE_FILE=yolo-fastest-1.1-person-int8_vela.tflite
